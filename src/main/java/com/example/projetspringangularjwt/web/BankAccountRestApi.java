...
import com.example.projetspringangularjwt.exceptions.BalanceNotSufficientException;
...
public class BankAccountRestApi {
    ...
    public DebitDTO debit(@RequestBody DebitDTO debitDTO) throws BankAccountNotFoundException, BalanceNotSufficientException {
        this.bankAccountService.debit(debitDTO.getAmount(),debitDTO.getAccountId(),debitDTO.getDescription());
        return debitDTO;
    }
    @PostMapping("/accounts/credit")
    public CreditDTO credit(@RequestBody CreditDTO creditDTO) throws BankAccountNotFoundException {
        this.bankAccountService.credit(creditDTO.getAmount(),creditDTO.getAccountId(),creditDTO.getDescription());
        return creditDTO;
    }
